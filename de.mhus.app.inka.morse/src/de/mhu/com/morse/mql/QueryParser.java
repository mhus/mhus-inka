...
public class QueryParser {
	...
	private static QueryConfig config = ((QueryConfig)ConfigManager.getConfig( "query" ));
	private boolean DEBUG = false;
	
	private static AL log = new AL( QueryParser.class );
	private QDNode node;
	...
	public ICompiledQuery compile(String[] parts, int offset, int end) throws MorseException {
		...
		if ( offset != end ) throw new MorseException( MorseException.PARSE_ERROR, toErrorMessage( parts, start, end, offset ) ); 
