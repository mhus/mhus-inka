...
public class FileAbstractLoadResultStream implements IQueryResult {

	private static AL log = new AL( FileAbstractLoadResultStream.class );
	
	private InputStream is;

	public FileAbstractLoadResultStream(FileAbstractChannel pChannel, String pId, ObjectFileStore pStore ) throws MorseException, FileNotFoundException {
		
		is = pStore.getInputStream( pId );
