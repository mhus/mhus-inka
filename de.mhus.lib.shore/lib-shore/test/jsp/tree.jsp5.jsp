...
<%
de.mhu.shore.ifc.Tree shoreTree = (de.mhu.shore.ifc.Tree)new de.mhu.web.ObjectTree();
...
out.print( "<a style=\"FONT-SIZE: 10px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif\" href=\"tree.jsp5.jsp?shoreTree_tree1_exp=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );
}
...
out.print( "<a href=\"tree.jsp5.jsp?shoreTree_tree1_click=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );

String extraImage = shoreNode.getImage( de.mhu.shore.ifc.tree.Document.EXTRA );
if ( extraImage != null ) {
if ( shoreNode.isClickable() )
out.print( "<a href=\"tree.jsp5.jsp?shoreTree_tree1_imgclick=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );
