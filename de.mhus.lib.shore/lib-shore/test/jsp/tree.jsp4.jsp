...
out.print( "<a style=\"FONT-SIZE: 10px; FONT-FAMILY: Verdana, Arial, Helvetica, sans-serif\" href=\"tree.jsp4.jsp?shoreTree_tree1_exp=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );
}
...
out.print( "<a href=\"tree.jsp4.jsp?shoreTree_tree1_imgclick=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );
...
out.print( "<a href=\"tree.jsp4.jsp?shoreTree_tree1_click=" + shoreTreeDoc.getNodeReference() + r + "#shoreTree_tree1_" + shoreTreeDoc.getNodeReference() + "\">" );
