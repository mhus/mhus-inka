...
public class ActionsListPlugin implements Plugin {
	...
	public void initPlugin(PluginNode pNode, PluginConfig pConfig)
		...
		panel = new ListTablePanel("Actions", new ListTablePanel.Listener() {

			public void clickedEvent(Container selected, MouseEvent e) {
				if (e.getButton() == MouseEvent.BUTTON1
						&& e.getClickCount() > 1) {
					// TODO Connection.open(
					// ((StructurePlugin.ActionContainer)selected
		...
		panel.showList(structure.getActionsAsList());
