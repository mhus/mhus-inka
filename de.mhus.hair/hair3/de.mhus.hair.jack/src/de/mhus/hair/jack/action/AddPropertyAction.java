...
public class AddPropertyAction extends CaoAction {

	public AddPropertyAction(MActivator activator, String resourceName) {
		super(activator, resourceName);
	}

	@Override
	public String getName() {
		return "select.add_property";
	}

	@Override
	public MForm createConfiguration(CaoList list, Object... initConfig)
			throws CaoException {
		return new AddPropertyOperation();
	}
	...
	public CaoOperation execute(CaoList list, Object configuration)
			throws CaoException {
		((AddPropertyOperation)configuration).setSources(list);
		return (AddPropertyOperation)configuration;	}
