...
//			    PrivateKey pk = kf.generatePrivate(spec);
			    ...
			    System.out.println("Exponent1:   " + exponent1.toString(16));
			    System.out.println("Exponent2:   " + exponent2.toString(16));
			    System.out.println("pubExpo:     " + publicExponent.toString(16));
			    System.out.println("privExpo:    " + privateExponent.toString(16));
			    System.out.println("prime1:      " + prime1.toString(16));
			    System.out.println("prime2:      " + prime2.toString(16));
			    System.out.println("Coefficient: " + coefficient.toString(16));
			    System.out.println();

			    // encode
			    byte[] content = "H".getBytes();
			    BigInteger decoded = new BigInteger(content);
			    

			    BigInteger encoded  = binaryPow(decoded, publicExponent, modulus);
			    ...
			    //BigDecimal dModulus = new BigDecimal(modulus);
			    BigDecimal dDecoded = new BigDecimal(decoded);
			    BigDecimal dEncoded = new BigDecimal(encoded.mod(modulus));
			    int dp = modulus.bitLength();
			    
			    BigDecimal encMod = new BigDecimal( encoded.mod(modulus));
			    
			    
			    
			    BigDecimal x = log10(dEncoded, dp)
			    		       .divide( 
			    		       log10(dDecoded, dp)     ,BigDecimal.ROUND_DOWN );
			    
			    System.out.println(privateExponent.toString() );
			    System.out.println(x.toString());
			    System.out.println("-----");
			    System.out.println( x.subtract( new BigDecimal(privateExponent) ));
			    ...
			    System.out.println( 
			    		log10(new BigDecimal(81), 10)
			    		.divide( 
			    		log10(new BigDecimal(3), 10), BigDecimal.ROUND_DOWN) );
